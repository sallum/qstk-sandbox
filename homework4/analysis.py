...
dt_start = dt.datetime( value_data.iloc[[0]][0], value_data.iloc[[0]][1], value_data.iloc[[0]][2])
dt_end = dt.datetime( value_data.iloc[[df_lastrow]][0], value_data.iloc[[df_lastrow]][1], value_data.iloc[[df_lastrow]][2] + 1 )
