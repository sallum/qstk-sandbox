...
orderDF = orderDF.sort_values([0, 1, 2])
#print(orderDF)
...
dt_start = dt.datetime(orderDF.iloc[[0]][0],orderDF.iloc[[0]][1],orderDF.iloc[[0]][2])
#dt_end = dt.datetime( orderDF.get_value(df_lastrow, 0), orderDF.get_value(df_lastrow, 1), orderDF.get_value(df_lastrow, 2) + 1 )
dt_end = dt.datetime(orderDF.iloc[[df_lastrow]][0],orderDF.iloc[[df_lastrow]][1],orderDF.iloc[[df_lastrow]][2] + 1) 
